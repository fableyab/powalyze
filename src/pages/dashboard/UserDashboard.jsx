...
const UserDashboard = () => {
  ...
  const chartData = [
    { name: t('charts.month', 'Mon'), uploads: 2, rows: 2400 },
  ...
  return (
    <div className="space-y-6">
       <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
             <h1 className="text-2xl font-bold text-white">{t('common.dashboard', 'Dashboard Overview')}</h1>
             <p className="text-gray-400">{t('common.welcome', 'Welcome back to your command center.')}</p>
          </div>
          <Link to="/upload-excel">
             <Button className="bg-[#BFA76A] text-black hover:bg-white font-bold">
                <UploadCloud className="mr-2" size={18} /> {t('common.newUpload', 'New Upload')}
             </Button>
          </Link>
       </div>
       ...
       <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="bg-[#111] border-white/10">
             <CardContent className="p-6 flex items-center justify-between">
                <div>
                   <p className="text-gray-500 text-sm font-medium">{t('common.totalStorage', 'Total Storage Used')}</p>
          ...
          <Card className="bg-[#111] border-white/10">
             <CardContent className="p-6 flex items-center justify-between">
                <div>
                   <p className="text-gray-500 text-sm font-medium">{t('common.totalFiles', 'Total Files')}</p>
