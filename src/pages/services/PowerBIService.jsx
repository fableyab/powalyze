...
import { BarChart2, Gauge, LineChart, PieChart, ArrowLeft, CheckCircle2 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="pt-24 pb-20">
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              <div className="flex items-center gap-4 mb-6">
                ...
                <h1 className="text-5xl md:text-6xl font-extralight text-[#D4AF37]">Power BI Expert</h1>
              </div>
              
              <p className="text-xl font-light text-[#4A9EFF] mb-8 leading-relaxed">
                Dashboards exécutifs, KPI stratégiques, reporting automatisé
              </p>
              
              <p className="text-base font-light text-white/70 leading-relaxed max-w-3xl">
                L'excellence Power BI au service de votre gouvernance. Dashboards percutants, 
                modèles optimisés et reporting automatique pour vos comités stratégiques.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-20 px-6 border-b border-white/5">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <h2 className="text-3xl md:text-4xl font-extralight mb-8">Nos services Power BI</h2>
                ...
                {[
                  {
                    ...
                    desc: "Visualisations percutantes, design soigné, expérience utilisateur premium"
                  },
                  {
                    icon: LineChart,
                    title: "KPI stratégiques",
                    desc: "Métriques métier, tableaux de bord décisionnels, indicateurs temps réel"
                  },
                  {
                    icon: PieChart,
                    title: "Reporting automatisé",
                    desc: "Génération automatique, distribution planifiée, exports personnalisés"
                  },
                  {
                    icon: BarChart2,
                    title: "Optimisation des modèles",
                    desc: "Performance maximale, DAX avancé, architecture scalable"
                  }
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <section className="py-20 px-6 border-b border-white/5">
          <div className="max-w-5xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <h2 className="text-3xl md:text-4xl font-extralight mb-8 text-[#D4AF37]">Excellence technique</h2>
              
              <div className="space-y-6">
                {[
                  { title: "Expertise reconnue", desc: "15+ ans d'expérience Power BI sur des projets stratégiques" },
                  { title: "Dashboards performants", desc: "Temps de chargement optimaux même sur volumes importants" },
                  { title: "DAX avancé", desc: "Mesures complexes, time intelligence, calculs métier sophistiqués" },
                  { title: "Design soigné", desc: "Expérience utilisateur premium, cohérence visuelle, accessibilité" },
                  { title: "Intégration complète", desc: "Connexion fluide avec Powalyze SaaS et vos outils existants" }
                ].map((item, i) => (
                  <motion.div
                    key={i}
        ...
        <section className="py-20 px-6">
          <div className="max-w-5xl mx-auto text-center">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <h2 className="text-3xl md:text-4xl font-extralight mb-6 text-[#D4AF37]">Excellence Power BI</h2>
              <p className="text-lg font-light text-white/70 mb-8 max-w-2xl mx-auto">
                Transformez vos données en intelligence décisionnelle
              </p>
