        ...
        <div className="bg-[#111] border border-white/10 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                type="text" 
                defaultValue="Powalyze PMO" 
                className="w-full bg-[#0A0A0A] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-red-500/50 focus:outline-none" 
              />
            </div>
            <div>
              ...
              <input 
                type="text" 
                defaultValue="https://powalyze.com" 
                className="w-full bg-[#0A0A0A] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-red-500/50 focus:outline-none" 
              />
            </div>
          ...
          <div className="space-y-4">
            <label className="flex items-center gap-3 cursor-pointer">
              <input 
                type="checkbox" 
                defaultChecked 
                className="w-5 h-5 rounded border-white/10 bg-[#0A0A0A] text-red-500 focus:ring-red-500/50" 
              />
        ...
        <div className="bg-[#111] border border-white/10 rounded-lg p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input 
                type="text" 
                defaultValue="smtp.powalyze.com" 
                className="w-full bg-[#0A0A0A] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-red-500/50 focus:outline-none" 
              />
            </div>
            <div>
              ...
              <input 
                type="email" 
                defaultValue="noreply@powalyze.com" 
                className="w-full bg-[#0A0A0A] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-red-500/50 focus:outline-none" 
              />
            </div>
          </div>
