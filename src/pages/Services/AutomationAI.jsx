    ...
    <div className="bg-[#050505] min-h-screen text-white font-sans">
      ...
      <main>
        <section className="relative pt-32 pb-24 overflow-hidden">
           <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-[#050505] to-[#050505] z-0"></div>
           <div className="container mx-auto px-6 relative z-10">
              <Breadcrumbs items={[{ label: 'Services', path: '/services' }, { label: 'Automation & AI', path: null }]} />
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="max-w-4xl mt-12">
                 ...
                 <Link to="/contact"><Button className="bg-purple-600 hover:bg-purple-500 text-white px-8 py-6 text-lg rounded-full font-bold shadow-[0_0_20px_rgba(147,51,234,0.3)]">{content.hero.cta}</Button></Link>
              </motion.div>
           </div>
        </section>
        ...
        <section className="py-20 container mx-auto px-6">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <img src="https://images.unsplash.com/photo-1620712943543-bcc4688e7485?auto=format&fit=crop&q=80" alt="AI" className="rounded-2xl border border-white/10 shadow-2xl" />
           </div>
        </section>
           ...
           <div className="container mx-auto px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                 {content.benefits.map((b, i) => (
                    <div key={i} className="bg-[#1A1A1A] p-8 rounded-xl border border-white/5 hover:border-purple-500/50 transition-colors">
                       <b.icon className="text-purple-500 mb-4" size={32} />
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {content.features.map((f, i) => (
                 <div key={i} className="flex gap-4 p-4 border border-white/10 rounded-lg">
                    <f.icon className="text-purple-500 shrink-0" size={24} />
        ...
        <section className="py-24 text-center container mx-auto px-6">
           ...
           <Link to="/contact"><Button className="bg-purple-600 text-white rounded-full px-8">{content.cta.btnDemo}</Button></Link>
        </section>
      </main>
      <FooterSection />
    </div>
