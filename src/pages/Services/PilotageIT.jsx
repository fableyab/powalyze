      ...
      <main>
        ...
        <section className="relative pt-32 pb-24 overflow-hidden">
           ...
           <div className="container mx-auto px-6 relative z-10">
              <Breadcrumbs items={[{ label: 'Services', path: '/services' }, { label: 'Pilotage IT', path: null }]} />
              <motion.div 
              ...
              >
                 ...
                 <div className="flex flex-wrap gap-4">
                    <Link to="/contact">
                       <Button className="bg-[#3A7BFF] hover:bg-blue-600 text-white px-8 py-6 text-lg rounded-full">
                          {content.hero.cta}
                       </Button>
                    </Link>
                 </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {content.methodology.map((step, idx) => (
                 <div key={idx} className="text-center">
                    <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-[#BFA76A] text-black flex items-center justify-center text-2xl font-bold">
                       {idx + 1}
                    </div>
                 ...
                 {content.useCases.map((useCase, idx) => {
                    ...
                    return (
                       <div key={idx} className="bg-[#0A0A0A] p-8 rounded-xl border border-white/10">
                          <Icon size={40} className="text-[#BFA76A] mb-4" />
        ...
        <section className="py-20 container mx-auto px-6 text-center">
           <h2 className="text-4xl font-display font-bold mb-6">Prêt à transformer votre DSI ?</h2>
           <Link to="/contact">
              <Button className="bg-[#BFA76A] text-black hover:bg-white font-bold px-12 py-6 text-lg">
