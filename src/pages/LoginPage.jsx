...
const LoginPage = () => {
  ...
  const handleDemoLogin = async () => {
    ...
    try {
      ...
      setTimeout(() => navigate('/espace-client'), 500);
    } catch (error) {
        ...
        <div className="w-full max-w-md bg-[#111] border border-white/10 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="mb-6 space-y-3">
            ...
            >
              ...
              {t('login.demoAccess', 'Demo Access')}
            </Button>
            ...
            >
               ...
               {t('login.azureButton', 'Sign in with Microsoft Azure AD')}
            </Button>
            ...
            <div className="relative my-6">
               ...
               <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#111] px-2 text-gray-500">{t('login.orContinue', 'Or continue with email')}</span>
               </div>
            </div>
          </div>
