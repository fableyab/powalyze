           ...
           <div className="mt-16 pt-8 border-t border-[#222]">
              ...
              {user ? (
                 ...
                 <div className="bg-[#111] p-6 text-center rounded mb-10">
                    <p className="text-gray-400 mb-4">{t('common.loginRequired', 'Please log in to participate in the discussion.')}</p>
                    <Link to="/login"><Button variant="outline">{t('login.submitButton', 'Sign In')}</Button></Link>
                 </div>
              )}
