...
const PMOReportPage = () => {
  const data = sampleDataService.generatePMOData();
      ...
      <main className="pt-32 pb-20 container mx-auto px-6">
        <div className="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
          <div>
            ...
            <h1 className="text-4xl font-display font-bold">PMO Executive Report</h1>
            <p className="text-gray-400 max-w-2xl mt-2">
              Vue consolidée pour le comité de direction : Santé, Risques, Conformité.
            </p>
          </div>
