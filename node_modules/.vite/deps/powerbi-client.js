                        ...
                        if (s2) {
                          ...
                          if ("object" == typeof n) {
                            ...
                            if (o && (t = this.pendingRequestPromises[o.id]), t) {
                              ...
                              this.handlers.some(function(e4) {
                                var t2 = false;
                                try {
                                  t2 = e4.test(n);
                                } catch (e5) {
                            ...
                            this.suppressWarnings || console.warn("Proxy(".concat(this.name, "): Received message that was not an object. Discarding message"));
                        }
...
export default require_powerbi();
